...
function generateNumericUUID(length = 6) {
	...
	return uuid.slice(0, length) // Take the first `length` digits
}
const FormComponent: FC<FormikProps<IFormValues>> = ({ handleSubmit, values, initialValues, resetForm, setFieldValue, setValues }) => {
